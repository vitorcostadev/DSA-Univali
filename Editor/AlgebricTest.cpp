...
void initMessage();
bool parseUserInput(string);
bool isValidCommand(string, vector<string>);
int getValueFromCommand(string);
string getCommandWithoutValue(string);
...
int main(){
    ...
    Stack<Pass<int>> stack; create(stack);
    ...
    do{
        initMessage(); cout << endl;
        cout << "--> Digite o comando (PREFIXO " << PREFIX <<"): "; getline(cin, userInput);
